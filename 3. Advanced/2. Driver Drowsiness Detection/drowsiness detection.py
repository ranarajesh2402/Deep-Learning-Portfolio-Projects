...
# Follow  this - https://www.tensorflow.org/install/source_windows#gpu for installing tensorflow
# on windows with CUDA and cudnn requirements, if code is not working.
...
while(True):
    ...
    for (x, y, w, h) in right_eye:
        ...
        label_idx1 = np.argmax(rpred, axis=1)
        if(label_idx1[0] == 1):
            lbl = 'Open'
        if(label_idx1[0] == 0):
            lbl = 'Closed'
    ...
    for (x, y, w, h) in left_eye:
        ...
        label_idx2 = np.argmax(lpred, axis=1)
        if(label_idx2[0] == 1):
            lbl = 'Open'
        if(label_idx2[0] == 0):
            lbl = 'Closed'
    ...
    if(label_idx1[0] == 0 and label_idx2[0] == 0):
        score = score+1
