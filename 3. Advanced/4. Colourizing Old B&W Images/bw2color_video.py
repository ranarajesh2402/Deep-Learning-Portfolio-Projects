# Code Reference : https://pyimagesearch.com/2019/02/25/black-and-white-image-colorization-with-opencv-and-deep-learning/

# Download 'colorization_release_v2.caffemodel' from https://people.eecs.berkeley.edu/~rich.zhang/projects/2016_colorization/files/demo_v2/colorization_release_v2.caffemodel
# or from https://people.eecs.berkeley.edu/~rich.zhang/projects/2016_colorization/files/demo_v2/ and then move it to 'models' folder.
...
# Run the these 3 commands in terminal to test the colorization. Press q to exit. 

# python bw2color_video.py  --prototxt models/colorization_deploy_v2.prototxt  --model models/colorization_release_v2.caffemodel  --points models/pts_in_hull.npy  --input image_video/pixel_video.mp4

# python bw2color_video.py  --prototxt models/colorization_deploy_v2.prototxt  --model models/colorization_release_v2.caffemodel  --points models/pts_in_hull.npy  --input image_video/pixel_video2.mp4

# python bw2color_video.py  --prototxt models/colorization_deploy_v2.prototxt  --model models/colorization_release_v2.caffemodel  --points models/pts_in_hull.npy  --input image_video/pixel_video3.mp4
